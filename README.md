...
Easily create **gzip** shareable links. Built in 10 minutes. :smile:

Dead simple mash-up of [pako](https://github.com/nodeca/pako) and [js-base64](https://github.com/dankogai/js-base64) to create **gzipped** URL-safe base64 strings from any data on the browser. Very useful for passing large datasets via web links.
...
If you're using GAS somwhere in your pipeline, `zipurl` is supported natively (kindof).
